    ...
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; max-width: 680px; margin: 0 auto; color: #1e293b; line-height: 1.5;">
      ...
      <div style="background: #ffffff; border: 1px solid #e2e8f0; border-top: none; border-radius: 0 0 12px 12px; padding: 28px 32px;">
        ...
        <p style="margin: 28px 0 0; text-align: center;">
          <a href="${esc(appUrl)}" style="display: inline-block; background: #2563eb; color: #ffffff; font-weight: 600; font-size: 14px; text-decoration: none; padding: 12px 28px; border-radius: 8px;">Open Incident Tracker</a>
        </p>
        <p style="margin: 20px 0 0; font-size: 12px; color: #94a3b8; text-align: center;">Sent daily at 8:00 AM GMT+7 · Incident Tracker</p>
      </div>
    </div>
  `.trim()
}
